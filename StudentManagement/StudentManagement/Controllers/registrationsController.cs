...
namespace StudentManagement.Controllers
{
    public class registrationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstnaame,lastname,nic,course_id,batch_id,telno")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstnaame,lastname,nic,course_id,batch_id,telno")] registration registration)
        {
            if (ModelState.IsValid)
            {
